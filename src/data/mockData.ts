...
export const events: Event[] = [
  {
    ...
    description:
      'Join us for our flagship 2025 event where visionaries, innovators, and changemakers come together to share ideas worth spreading. This year\'s theme "Ideas Ignited" celebrates the spark of creativity that drives transformation.',
    isFlagship: true,
  },
  {
    id: "2",
    ...
    description:
      "Our 2024 conference explored how individuals and communities break through limitations to achieve extraordinary outcomes.",
    isFlagship: false,
  ...
  },
  {
    ...
    description:
      "Looking ahead to the technologies, ideas, and movements shaping tomorrow.",
    isFlagship: false,
    albumUrl: "https://photos.google.com/example",
  },
];
...
export const speakers: Speaker[] = [
  ...
  },
  {
    ...
    fullBio:
      "Marcus Williams founded the Chicago Urban Innovation Lab to create sustainable economic opportunities in underserved neighborhoods. His initiatives have created over 500 jobs and launched 50 small businesses across the South and West sides of Chicago.",
  },
  {
    id: "3",
    ...
    shortBio:
      "Climate activist and researcher focused on urban sustainability.",
    fullBio:
      "Professor Sarah Okonkwo combines rigorous climate science with community activism. Her research on urban heat islands has influenced Chicago's green infrastructure policies, and she leads citizen science initiatives engaging thousands of Chicagoans in climate action.",
  },
  {
    id: "4",
    slug: "alex-rivera",
    ...
    fullBio:
      "Alex Rivera is the founder of Catalyst AI, a startup developing AI-powered learning tools designed to provide personalized education to students regardless of their background. A first-generation college graduate from UIC, Alex is passionate about using technology to level the playing field.",
  },
  {
    id: "5",
    slug: "dr-james-park",
    ...
    fullBio:
      "Dr. James Park leads a lab focused on making prosthetic limbs affordable and accessible through advanced 3D printing techniques. His team has provided custom prosthetics to over 200 patients in underserved communities.",
  },
];
...
export const eventSpeakers: EventSpeaker[] = [
  // 2025 Event Speakers
  {
    ...
    talkDescription:
      "Discover how recent breakthroughs in neuroscience are revolutionizing our understanding of learning and memory, and what this means for education in the 21st century.",
    youtubeUrl: "",
    order: 1,
  },
  {
    ...
    talkDescription:
      "How grassroots movements and local entrepreneurs are solving urban challenges from the ground up.",
    youtubeUrl: "",
    order: 2,
  },
  {
    ...
    talkDescription:
      "Why urban areas hold the key to addressing climate change and how Chicago is leading the way.",
    youtubeUrl: "",
    order: 3,
  },
  // 2024 Event Speakers
  {
    ...
    talkDescription:
      "How artificial intelligence can provide personalized learning experiences to students worldwide.",
  ...
  },
  {
    ...
    talkDescription:
      "3D printing is revolutionizing how we think about medical devices and accessibility.",
    youtubeUrl: "https://www.youtube.com/watch?v=dQw4w9WgXcQ",
    order: 2,
  },
];
...
export const teamMembers: TeamMember[] = [
  // Current Team
  {
    ...
    blurb:
      "Senior studying Business Administration with a passion for connecting ideas and people.",
    isCurrent: true,
  ...
  },
  {
    ...
    blurb:
      "Computer Science major focused on using technology for social good.",
    isCurrent: true,
    yearsActive: "2023-2025",
  },
  {
    ...
    blurb:
      "Passionate about finding diverse voices and perspectives for our stage.",
    isCurrent: true,
  ...
  },
  {
    ...
    blurb:
      "Creative strategist with a background in digital media and communications.",
    isCurrent: true,
    yearsActive: "2024-2025",
  },
  {
    ...
    blurb:
      "Industrial Engineering student who loves making events run smoothly.",
    isCurrent: true,
    yearsActive: "2024-2025",
  },
  // Alumni
  {
    ...
    headshot:
      "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400",
    blurb:
      "Led the organization through its 2022 and 2023 events. Now working in consulting.",
    isCurrent: false,
...
export const newsPosts: NewsPost[] = [
  {
    ...
    excerpt:
      "We are thrilled to announce our upcoming flagship event featuring an incredible lineup of speakers.",
...
Stay tuned for speaker announcements and registration details!`,
  ...
  },
  {
    ...
    excerpt:
      "Get to know our keynote speaker and her groundbreaking research on neuroplasticity.",
